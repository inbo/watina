...
test_that("get_chem works with different filters and dwh settings", {
  suppressWarnings({
    ...
    chem <- locs %>%
      ...
      collect()
    expect_chem(chem, "chem_exclude_na_threshold_na")
  })
})
