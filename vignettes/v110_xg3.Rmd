...
We can store specific conditions in a dataframe; the available conditions are explained by the documentation of `eval_xg3_avail()` and `eval_xg3_series()`:
...
With the argument `list = TRUE` you can also obtain intermediate results of the test.
